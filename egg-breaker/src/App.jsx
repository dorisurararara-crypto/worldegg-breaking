...
const TRANSLATIONS = {
  US: { 
    ...
    maxAtkTitle: "Highest Attack", serverStatusTitle: "Server Status", participants: "Active", waiting: "Queue", spectators: "Spectators", totalOnline: "Total Online"
  },
  KR: { 
    ...
    tapToClose: "(탭하여 없애기)",
    maxAtkTitle: "최고 공격력", serverStatusTitle: "서버 현황", participants: "참여자", waiting: "대기자", spectators: "구경꾼", totalOnline: "Total Online"
  },
  JP: { 
    ...
    tapToClose: "(タップして閉じる)",
    maxAtkTitle: "最高攻撃力", serverStatusTitle: "サーバー状況", participants: "参加者", waiting: "待機中", spectators: "観戦者", totalOnline: "Total Online"
  },
  CN: { 
    ...
    tapToClose: "(点击关闭)",
    maxAtkTitle: "最高攻击力", serverStatusTitle: "服务器状态", participants: "参与者", waiting: "排队中", spectators: "旁观者", totalOnline: "Total Online"
  }
};
