export const TRANSLATIONS = {
  ...
  KR: {
    label: "한국어", title: "에그퐁 ☁️", subtitle: "다함께 퐁! 전설의 알 깨기 💕", users: "접속자", total: "총", shop: "마법 상점 ✨", myPoint: "보유 포인트", atk: "공격력", item1: "🌸 핑크 망치", item2: "💎 크리스탈 곡괭이", item3: "🎀 리본 폭탄", item4: "🌈 레인보우 드릴", item5: "🦄 유니콘 포크레인", item6: "⭐ 별빛 레이저", item7: "🌟 슈퍼노바", modalTitle: "🎉 축하합니다! 🎉", modalDesc: "마지막 일격을 가해 알을 깨트리셨습니다! 당신이 바로 전설의 파괴자입니다.", modalPrize: "상품 수령을 위해 이메일 주소를 입력해주세요(새로고침을 누르지 마세요! 초기화됩니다.):", send: "상품 신청하기", adText: "광고 영역", powerClick: "⚡ 파워 클릭 (+100) ⚡", watchAd: "광고 보고 ", logo: "에그퐁 ☁️",
    ...
    eggFacts: [
      ...
      "✨ 계란 껍질도 숨을 쉰대요~ 신기하죠?",
      "🌊 신선한 계란은 물에 풍덩 가라앉아요!",
      "🎨 노른자 색은 닭이 먹는 음식에 따라 달라져요!",
      "🐣 닭은 1년에 약 300개의 알을 낳아요!",
      "🍳 계란 요리는 100가지가 넘어요!",
      "💪 운동 후 계란을 먹으면 근육 회복에 좋아요!",
      "🌈 희귀한 파란색 알을 낳는 닭도 있어요!",
      "🎁 클릭할 때마다 럭키 이벤트가 터질 수 있어요!"
    ]
  },
  JP: { 
