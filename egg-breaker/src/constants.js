export const TRANSLATIONS = {
  US: { 
    ...
    notEnoughPoints: "Points not enough!", alreadyShared: "You already received the share reward for this round!", shareSuccess: "Link shared! You will get 800P when your friend plays.", inviteSuccess: "Friend joined! You got 800 Points!", welcomeBack: "Welcome back!", sent: "Sent successfully!", bought: "Bought",
    newRoundReset: "New Round Started! All progress has been reset.",
    shopGuide: "Click the shop on the right to get powerful items!",
    touchGuide: "Touch the egg in the middle! 👈",
    crackWarning: "The egg is cracking more! ⚡",
    ...
    savePrizeBtn: "💾 Save Prize", prizeReceivedBtn: "✅ Prize Received",
  ...
  KR: {
    label: "한국어", title: "에그퐁", subtitle: "전 세계가 함께하는 알 깨기 챌린지", users: "접속자", total: "총", shop: "상점", myPoint: "보유 포인트", atk: "공격력", item1: "강화 망치", item2: "정밀 곡괭이", item3: "폭발물", item4: "전동 드릴", item5: "중장비", item6: "레이저 커터", item7: "플라즈마 캐논", modalTitle: "🎉 축하합니다! 🎉", modalDesc: "마지막 일격을 가해 알을 깨트리셨습니다! 당신이 바로 전설의 파괴자입니다.", modalPrize: "상품 수령을 위해 이메일 주소를 입력해주세요(새로고침을 누르지 마세요! 초기화됩니다.):", send: "상품 신청하기", adText: "광고 영역", powerClick: "⚡ 파워 클릭 (+100) ⚡", watchAd: "광고 보고 ", logo: "에그퐁",
    ...
    notEnoughPoints: "포인트가 부족합니다!", alreadyShared: "이번 라운드에는 이미 공유 보상을 받으셨습니다!", shareSuccess: "링크 공유 완료! 친구가 접속하면 800P가 지급됩니다.", inviteSuccess: "친구가 접속했습니다! 800 포인트를 획득했습니다!", welcomeBack: "다시 오셨군요!", sent: "전송되었습니다!", bought: "구매 완료:",
    ...
    eggFacts: [
      "계란은 완전식품으로 불립니다",
      "타조알은 세상에서 가장 큰 알입니다",
      "계란 껍질에는 약 7,500개의 기공이 있습니다",
      "신선한 계란은 물에 가라앉습니다",
      "노른자 색은 사료에 따라 달라집니다",
      "닭 한 마리가 1년에 약 300개의 알을 낳습니다",
      "전 세계적으로 매일 약 20억 개의 달걀이 소비됩니다",
      "달걀 흰자에는 40가지 이상의 단백질이 있습니다",
      "아라우카나 닭은 파란색 알을 낳습니다",
      "클릭할 때마다 보너스 포인트가 나올 수 있습니다"
    ]
  },
  JP: { 
    ...
    notEnoughPoints: "ポイントが足りません！", alreadyShared: "このラウンドのシェア報酬は既に受け取っています！", shareSuccess: "リンクをシェアしました！友達が参加すると800Pもらえます。", inviteSuccess: "友達が参加しました！800ポイントを獲得しました！", welcomeBack: "お帰りなさい！", sent: "送信しました！", bought: "購入完了:",
    newRoundReset: "新しいラウンドが始まりました！すべての進行状況がリセットされました。",
    shopGuide: "右のショップをクリックして強力なアイテムを手に入れよう！",
    touchGuide: "真ん中の卵を 👈 タッチしてください！",
    crackWarning: "卵のヒビが広がっています！ ⚡",
    ...
    winnerTimerWarning: "5분 이내に入力してください。", winnerExitMsg: "送信しました！まもなく終了します (新ウィンドウ)", loserMsg: "残念ながら失敗しました。まもなく終了します (新ウィンドウ)", timeLeft: "残り時間",
    savePrizeBtn: "💾 賞品を保存", prizeReceivedBtn: "✅ 受領完了",
  ...
  CN: { 
    ...
    notEnoughPoints: "积分不足！", alreadyShared: "本轮已领取分享奖励！", shareSuccess: "链接已分享！好友进入游戏时您将获得800积分。", inviteSuccess: "好友已加入！获得800积分！", welcomeBack: "欢迎回来！", sent: "已发送！", bought: "购买成功:",
    newRoundReset: "新一轮开始了！所有进度已重置。",
    shopGuide: "点击右侧商店购买强力道具！",
    touchGuide: "点击中间的蛋 👈 ！",
    crackWarning: "蛋的裂缝在扩大！ ⚡",
    ...
    savePrizeBtn: "💾 保存奖品", prizeReceivedBtn: "✅ 已领取",
